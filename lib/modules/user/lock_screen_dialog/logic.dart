...
class LockScreenDialogLogic extends BaseLogic {
  ...
  void onComplete(List<int?> data) {
    ...
    if (result == gesturePassword) Get.back(result: true);
  }
  ...
  void textChange(BuildContext context, String value) {
    ...
    if (value.length == maxCount) {
      ...
      if (password == numberPassword) {
        Log.d("ddddddddddddddddddddddddddddddddd");
