      ...
      Scaffold(
          ...
          body: Column(children: [
            ...
            Container(
                ...
                child: Text("账户余额",
                    style: GoogleFonts.roboto(fontWeight: FontWeight.w600, color: Colors.white, fontSize: 18.sp))),
            Container(
                margin: EdgeInsets.only(bottom: 20.h),
                alignment: Alignment.centerLeft,
                padding: EdgeInsets.symmetric(horizontal: 22.w),
                child: Text("${Get.find<RootLogic>().user.value?.money}",
                    style: GoogleFonts.roboto(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 44.sp))),
            Expanded(
                child: Container(
