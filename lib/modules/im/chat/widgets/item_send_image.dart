...
class ItemSendImage extends StatelessWidget {
  final MessageEntity message;
  final FileEntity file;

  const ItemSendImage({super.key, required this.message, required this.file});
            ...
            child: ExtendedImage.network("${file.thumbUrl}",
              ...
              if (state.extendedImageLoadState == LoadState.completed) {
                ...
                return ExtendedRawImage(
                    height: boxHeight, width: boxWidth, image: state.extendedImageInfo!.image, fit: BoxFit.cover);
              }
              return null;
            })));
  }
